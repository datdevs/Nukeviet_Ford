...
nv_redirect_location(NV_BASE_SITEURL . NV_ADMINDIR . '/' . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&' . NV_NAME_VARIABLE . '=' . $module_data . '&' . NV_OP_VARIABLE . '=items');
// 'http://ford.io/vuji/index.php?language=vi&nv=cars&op=items'
