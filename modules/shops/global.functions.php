...
function nv_link_edit_page($id)
{
    ...
    $link = "<a class='btn btn-primary btn-sm' href=\"" . NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=content&amp;id=" . $id . "\" title=\"" . $lang_global['edit'] . "\">" . $lang_global['edit'] . "</a>";
    return $link;
}
...
{
    global $lang_global, $module_name;
    $link = "<a class='btn btn-danger btn-sm' href=\"javascript:void(0);\" onclick=\"nv_del_content(" . $id . ", '" . md5($id . session_id()) . "','" . NV_BASE_ADMINURL . "')\" title=\"" . $lang_global['delete'] . "\">" . $lang_global['delete'] . "</a>";
    return $link;
}
