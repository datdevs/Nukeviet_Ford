...
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_rows ADD " . $lang . "_title VARCHAR( 250 ) NOT NULL DEFAULT '',
 ...
 ADD " . $lang . "_specs mediumtext NOT NULL,
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_dang_kiem (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
  value float NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
  KEY apply_for (apply_for),
 ) ENGINE=MyISAM";

$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_dang_ky (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
  value float NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_insurrance_car (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
  value float NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_insurrance_per (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
  value float NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_plates (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
  value float NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_road (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_fees_tax (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  apply_for int(11) NOT NULL DEFAULT '0',
  value float NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
