...
if (! nv_function_exists('nv_contact_call_button')) {
    function nv_contact_call_button($module)
    {
        ...
        if (isset($site_mods[$module])) {
            ...
            $xtpl = new XTemplate('block.call_button.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $site_mods[$module]['module_file']);
...
if (defined('NV_SYSTEM')) {
    $content = nv_contact_call_button($block_config['module']);
}