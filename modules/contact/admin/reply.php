...
if ($nv_Request->get_int('save', 'post') == '1') {
    ...
    $mess_content .= '--------------------------------------------------------------------------------<br />';
    $mess_content .= '<strong>Subject:</strong> ' . $row['title'] . '<br />';
    $mess_content .= '<strong>From:</strong> ' . $row['sender_name'] . ' [mailto:' . $row['sender_email'] . ']<br />';
    $mess_content .= '<strong>To:</strong> ' . $global_config['site_name'] . '<br />';
    $mess_content .= '<strong>Sent:</strong> ' . date('r', $row['send_time']) . '<br /><br />';
