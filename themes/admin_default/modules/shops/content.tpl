		...
		<div class="col-sm-24 col-md-18">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input type="button" class="btn btn-info" onclick="nv_add_otherimage();" value="Thêm thư viện ảnh">
				</div>
			</div>

			<div class="panel panel-default">
				<div class="panel-heading">Hình minh họa khác</div>
				<div class="panel-body">
					<div id="prod_more_image_ver">
						<!-- BEGIN: prod_ver -->
						<div class="form-group">
							<div class="input-group">
								<input value="{PROD_VER.value}" name="prod_image_ver[]" id="prod_image_ver_{PROD_VER.id}" class="form-control">
								<span class="input-group-btn">
									<button class="btn btn-default" type="button" onclick="nv_open_browse( '{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=prod_image_ver_{PROD_VER.id}&path={NV_UPLOADS_DIR}/{MODULE_UPLOAD}&currentpath={CURRENT}&type=file', 'NVImg', 850, 500, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no' ); return false; ">
										<em class="fa fa-folder-open-o fa-fix">&nbsp;</em>
									</button>
								</span>
							</div>
					...
					<input type="button" class="btn btn-info" onclick="nv_add_otherprodimage();" value="Thêm hình ảnh">
				</div>
			</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">Bảng thông số kỹ thuật (Nên sử dụng Table)</div>
				<div class="panel-body">{edit_specs}</div>
			</div>
...
<script type="text/javascript">
  ...
  var prod_file_items = '{PROD_FILE_ITEMS}';
