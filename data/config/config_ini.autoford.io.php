 ...
 * @Createdate Thu, 19 Aug 2021 02:29:04 GMT
 */
...
$sys_info['server_headers'] = ['server' => 'Apache/2.4.27 (Unix) OpenSSL/1.0.1p PHP/7.1.8','x-powered-by' => 'PHP/7.1.8','content-length' => '0','content-type' => 'text/html; charset=UTF-8'];
